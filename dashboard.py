...
@st.cache_data
def load_data():
    users = pd.read_csv("User Data 12 May 2025.csv")
    purchases = pd.read_csv("Purchase Data 12 May 2025.csv")
...
with col1:
    start_date = st.date_input(
            "Start Date",
            value=datetime(2020, 5, 1).date(),  # Set default to April 1, 2020
            min_value=min_date,
            max_value=max_date
    )
with col2:
